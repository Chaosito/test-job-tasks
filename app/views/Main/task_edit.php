		...
		<div class="col">
			...
			<form method="POST">
				...
				<div class="mb-3 form-check">
					<input type="checkbox" class="form-check-input" value="1" name="is_complete" id="is_complete" <?=(int)$this->is_complete ? 'checked' : '';?>>
					<label class="form-check-label" for="is_complete">Completed Task</label>
				</div>
				<input type="hidden" value="1" name="from_edit" />
